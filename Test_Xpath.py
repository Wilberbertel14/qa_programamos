...
Current_Address = driver.find_element(By.XPATH, "//textarea[contains(@id,'currentAddress')]")
Current_Address.send_keys("Sincelejo")
time.sleep(2)

Permanent_Address = driver.find_element(By.XPATH, "//textarea[contains(@id,'permanentAddress')]")
